                      ...
                      <div class="row w-100 mx-0">
                        ...
                        ">Preencha os dados corretamente.</h6>
                              <form class="pt-3" method="POST" action="{{route('store_alunos')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  <input type="text" class="form-control form-control-lg" class="@error('nomeusuario') is-invalid @enderror" required name="nome_de_usuario" id="input-field3" placeholder="Nome de usuário" title="username de inicio de sessão">
                                </div>
