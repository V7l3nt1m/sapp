        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="/template/pages/ui-features/dropdowns.html">Mensagem</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="/template/pages/forms/basic_elements.html">Gerenciar</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Gerênciar</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Pendentes</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Recebidos</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Aprovados</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Em analise</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/icons/mdi.html">Reprovados</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/template/pages/charts/chartjs.html">Adicionar</a></li>
                <li class="nav-item"> <a class="nav-link" href="/template/pages/charts/chartjs.html">Gerenciar</a></li>
